...
public class KaptchaConfiguration {
    ...
    private static final String KAPTCHA_TEXTPROUCER_FONT_SIZE = "kaptcha.textproducer.font.size";
    ...
    /**
     * 边框颜色 合法值 r,g,b 或者  white black blue
     */
    ...
    public DefaultKaptcha producer(){
        ...
        properties.put(KAPTCHA_TEXTPROUCER_FONT_SIZE,DEFAULT_IMAGE_FONT_SIZE);
